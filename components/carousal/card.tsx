    ...
    <div className="relative w-full overflow-hidden" style={{ height: '68vh', minHeight: '380px' }}>
      {bgImage ? (
        ...
        <div
          ...
          style={{ background: `radial-gradient(ellipse at 30% 50%, ${color}22 0%, #080B14 70%)` }}
        />
      )}
      ...
      <div className="pointer-events-none absolute top-6 left-6 h-8 w-8">
        <div className="absolute top-0 left-0 h-[1px] w-full" style={{ background: color }} />
      ...
      <div className="pointer-events-none absolute top-4 right-4 flex flex-col items-end gap-1">
        <div className="flex items-center gap-1.5">
          ...
          <span
            ...
            style={{ fontFamily: 'Share Tech Mono, monospace', color: '#39FF14' }}
          >
            STREAMING
          </span>
        </div>
        <span
          className="text-[0.45rem] tracking-widest text-white/20"
      ...
      {/* Content */}
      <div className="absolute inset-0 flex items-end px-8 pb-12 md:px-12">
        <div className="flex max-w-2xl flex-col gap-3">
          {/* Type tag + year */}
          <div className="flex items-center gap-3">
            <span
              className="border px-2 py-0.5 text-[0.55rem] tracking-[0.2em] uppercase"
            ...
            {year && (
              <span
                className="text-[0.55rem] tracking-widest text-white/40"
                style={{ fontFamily: 'Share Tech Mono, monospace' }}
              >
                {year}
              </span>
            ...
            {show.vote_average > 0 && (
              <div
                className="flex items-center gap-1 border bg-black/60 px-1.5 py-0.5"
          ...
          {show.overview && (
            <p
              className="line-clamp-2 max-w-lg text-sm leading-relaxed text-white/60"
          ...
          <div className="flex items-center gap-3 pt-1">
            ...
            <Link href={href}>
              <button
                className="flex items-center gap-2 border border-white/15 px-4 py-2 text-[0.6rem] tracking-widest text-white/50 transition-all hover:border-white/30 hover:text-white/80"
                style={{ fontFamily: 'Share Tech Mono, monospace' }}
              >
