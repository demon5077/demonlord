...
const STEPS = [
  {
    ...
    desc: 'Describe the copyrighted work and its unique identifiers.',
  },
  {
    icon: AlertTriangle,
    title: 'Identify the link',
    desc: 'Provide the specific URL on DemonLord where content appears.',
  },
  {
    icon: Mail,
    title: 'Send your notice',
    desc: 'Include your contact info, statement of good faith, and signature.',
  },
  {
    icon: Clock,
    title: 'We respond in 48h',
    desc: 'We investigate and remove valid claims within 48 hours.',
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, color-mix(in srgb, var(--neon-yellow) 5%, transparent), transparent 60%)',
        }}
      >
        <div
        ...
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          <FadeIn>
            <div className="flex justify-center">
              <div
                ...
                style={{
                  background: 'color-mix(in srgb, var(--neon-yellow) 15%, transparent)',
          ...
          <FadeIn delay={100}>
            <div className="space-y-3">
              ...
              <p
                className="mx-auto max-w-xl text-sm leading-relaxed text-[hsl(var(--muted-foreground))]"
                style={{ fontFamily: 'Rajdhani, sans-serif' }}
              >
                DemonLord respects intellectual property rights. We do not host any media files —
                all streams are sourced from third-party providers. Valid DMCA notices are processed
                within 48 hours.
              </p>
            </div>
          </FadeIn>
      ...
      <div className="mx-auto max-w-3xl space-y-16 px-6 py-16">
        ...
        <FadeIn>
          <div
            ...
            style={{
              ...
              borderColor: 'color-mix(in srgb, var(--neon-yellow) 25%, transparent)',
            }}
          >
            <AlertTriangle
              size={20}
              style={{ color: 'var(--neon-yellow)', flexShrink: 0, marginTop: 2 }}
            />
            <div className="space-y-1">
              <p className="text-sm font-bold">We do not host any content.</p>
              <p
                className="text-sm leading-relaxed text-[hsl(var(--muted-foreground))]"
                style={{ fontFamily: 'Rajdhani, sans-serif' }}
              >
                DemonLord is a streaming aggregator. All media is hosted by external third-party
                services. To remove content at the source, contact the actual hosting provider. We
                can only remove links, not the underlying content.
              </p>
            </div>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={80}>
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {STEPS.map((s, i) => (
                <div key={i} className="card-cyber space-y-3 p-5">
                  <div className="flex items-center gap-3">
                    <div
                      className="flex h-8 w-8 items-center justify-center rounded-lg"
                      style={{
                        background: 'color-mix(in srgb, var(--neon-yellow) 12%, transparent)',
                      }}
                    >
                      <s.icon size={15} style={{ color: 'var(--neon-yellow)' }} />
                    </div>
                    <span
                      className="text-[0.6rem] tracking-widest text-[hsl(var(--muted-foreground))]"
                      style={{ fontFamily: 'Share Tech Mono, monospace' }}
                    >
                      STEP {i + 1}
                    </span>
        ...
        {[
          ...
          },
          {
            ...
            content:
              'DemonLord maintains a policy of terminating access for users who are found to be repeat infringers of copyright. We take intellectual property seriously and will act swiftly on legitimate claims.',
          },
        ].map((s, i) => (
        ...
        <FadeIn delay={200}>
          <div
            className="card-cyber space-y-4 p-6 text-center"
          ...
          >
            ...
            <a href="https://github.com/skgupta507" target="_blank" rel="noopener noreferrer">
              <button className="btn-neon px-6 py-2.5 text-xs">Contact via GitHub</button>
            </a>
          </div>
        </FadeIn>
