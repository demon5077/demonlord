...
export default async function MangaPage() {
  let trending: any[] = [];
  try {
    trending = await anilist.trendingManga();
  } catch {}
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p
            className="text-[0.6rem] tracking-widest text-white/30 uppercase"
      ...
      {trending.length > 0 && (
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <span
              className="text-[0.6rem] tracking-[0.25em] text-[#F9F002]/70 uppercase"
              style={{ fontFamily: 'Share Tech Mono, monospace' }}
            >
              // TRENDING MANGA
            </span>
            <div
              ...
              style={{ background: 'linear-gradient(90deg, rgba(249,240,2,0.3), transparent)' }}
            />
          </div>
